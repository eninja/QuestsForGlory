...
public class AlmostIncreasingSequenceTest {
  ...
  public void isItPossibleSimplyFalse() {
    ...
    assertFalse(AlmostIncreasingSequence.isItPossibleSecondVersion(seqImpossible));
  }

  @Test
  public void isItPossibleSimplyTrue() {
    int[] seqPossible = {5, 4, 6};
    assertTrue(AlmostIncreasingSequence.isItPossibleSecondVersion(seqPossible));
  }
  ...
  public void isItPossibleTenAndDuplicateOne() {
    ...
    assertFalse(AlmostIncreasingSequence.isItPossibleSecondVersion(seqPossible));
  }
